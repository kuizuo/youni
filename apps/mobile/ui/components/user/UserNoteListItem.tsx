...
import { Avatar, Paragraph, XStack, YStack, Image, SizableText, useTheme, Card } from '@/ui'
...
export const UserNoteListItem = (item: NoteItem): React.ReactNode => {
...
const UserAvatar = ({ item }: { item: NoteItem }): React.ReactNode => {
  return <Link href={`/user/${item.user.id}/profile`} asChild>
    <XStack gap='$2.5' alignItems='center' >
