...
- Do not create module-local `README.md` files just to document component boundaries. Make ownership clear through route-aligned folder names, concrete component filenames, and direct imports instead.
